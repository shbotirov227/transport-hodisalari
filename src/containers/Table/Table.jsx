                        ...
                        >
                            <Typography sx={{ width: "100%", flexShrink: 0 }}>
                                <TableContent
                                    ...
                                    vehicleBrand={
                                        item.vehicles[0].vehicle_brand.name_uz
                                    }
                                    vehicleModel={
                                        item.vehicles[0].vehicle_model.name_uz
                                    }
                                    vehicleColor={
                                        item.vehicles[0].vehicle_color.name_uz
                                    }
                            ...
                            <Typography>
                                <div style={{ display: "flex" }}>
                                    <div style={{ marginRight: "50px" }}>
                                        <h5>
                                            Yo'l holati:{" "}
                                            {item.road_condition.name_uz}
                                        </h5>
                                        <h5>
                                            Havo holati:{" "}
                                            {item.weather_condition.name_uz}
                                        </h5>
                                        <h5>
                                            Yo'l qismi: {item.road_part.name_uz}
                                        </h5>
                                        <h5>
                                            Yo'l sirti:{" "}
                                            {item.road_surface.name_uz}
                                        </h5>
                                    </div>
                                    ...
                                    <div style={{ marginRight: "50px" }}>
                                        ...
                                        <h5>
                                            Haydovchining yoshi va jinsi:{" "}
                                            {item.participants[0].age} yosh{" "}
                                            {item.participants[0]
                                                .gender_type === "male"
                                                ? "erkak"
                                                : item.participants[0]
                                        ...
                                        <h5>
                                            Hodisa ro'y bergan ko'cha nomi:{" "}
                                            {item.street_name}
                                        </h5>
                                    </div>
