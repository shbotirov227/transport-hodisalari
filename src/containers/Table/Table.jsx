                        ...
                        <AccordionSummary expandIcon={<ExpandMoreIcon />} aria-controls="panel1bh-content" id="panel1bh-header">
                            <Typography sx={{ width: "100%", flexShrink: 0 }}>
                                <TableContent
                                    style={{ border: 'none' }}
                                    key={item.id}
                                    regionName={item.region.name_uz}
                                    districtName={item.district.name_uz}
                        ...
                        <AccordionDetails>
                            <Typography>
                                <div style={{ display: "flex" }}>
                                    ...
                                    <div style={{ marginRight: "50px" }}>
                                        <h5>
                                            Buzilgan qoida: {item.participants.map((el) =>
                                                el.violation.map(
                                                    (el) => el.name_uz
                                                )
                                            )}
                                        ...
                                        <h5>
                                            Haydovchining yoshi va jinsi: {item.participants[0].age} yosh
                                            {
                                                item.participants[0].gender_type === "male" ? "erkak"
                                                : item.participants[0].gender_type === "female" ? "ayol" : undefined
                                            }
                                        </h5>
                                        <h5>
                                            Haydovchining holati:
                                            {
                                                item.participants[0].health_condition === "healthy" ? "sog'lom"
                                                : item.participants[0].health_condition === "died" ? "o'lgan"
                                                : item.participants[0].health_condition === "injured" ? "jarohatlangan" : undefined
                                            }
                                        </h5>
